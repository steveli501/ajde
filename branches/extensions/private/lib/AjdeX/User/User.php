...
{	
	...
	public function login()
	{
		if (empty($this->_data)) {
			// TODO:
			throw new AjdeX_Exception('Invalid user object');
		}
		$session = new Ajde_Session('user');
	...
	private function getCookieHash()
	{
		...
		if (!in_array('sha256', hash_algos())) {
			// TODO:
			throw new AjdeX_Exception('SHA-256 algorithm not available for hashing');
		}
		...
		if (empty($hash)) {
			// TODO:
			throw new AjdeX_Exception('SHA-256 algorithm failed');
		}
		return $hash;
	}
