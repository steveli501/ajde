...
class Ajde_Document_Format_Processor_Html_Compressor extends Ajde_Object_Static implements Ajde_Document_Format_Processor
{
	...
	public static function minifyHtml($html, $options = array("xhtml" => true))
	{
 ...
 * 
 * This will put all the HTML on one single line, reducing the size even
 * further (no line-breaks) at the cost of readability.
 */
