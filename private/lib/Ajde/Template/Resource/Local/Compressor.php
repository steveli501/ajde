...
abstract class Ajde_Template_Resource_Local_Compressor extends Ajde_Object_Standard
{
	...
	{
		$this->setBase(PRIVATE_DIR . CACHE_DIR);
	}
	...
	/**
	 *
	 * @param array $resources Array of Ajde_Template_Resource_Local
	 */
	...
	/**
	 *
	 * @param Ajde_Template_Resource_Local $resource 
	 */
	public function addResource(Ajde_Template_Resource_Local $resource)
	{
	...
	public function getHash()
	{
		if (!$this->has('hash'))
		{
			...
			{
				/* @var $resource Ajde_Template_Resource_Local */
	...
	public function process()
	{
		...
		return new Ajde_Template_Resource_Local_Compressed($this->getType(), $this->getFilename());
	}
