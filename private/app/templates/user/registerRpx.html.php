	...
	<div id="wrapper-center">
		<div id="contents">
			...
			<div class="wide">
				...
				<form action="/user/saveRpx" method="post">
				<dl>
					<dt><label for="username">Username:</label> <span class="required">required</span></dt>
					<dd>
					...
					<dt><label for="email">E-mail address:</label> <span class="required">required</span></dt>
					<dd>
					...
					<dt></dt>
					<dd><input type="submit" value="Create account"/> or <a href="/user/register">Cancel</a></dd>
				</dl>
				</form>
			</div>
			<div class="clear"></div>
